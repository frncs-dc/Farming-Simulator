...
public class Sunflower extends Plants{
    public Sunflower(Farmer player){
        ...
        this.waterNeeded = 2;
        this.waterBonusLimit = (super.waterBonusLimit + 3) + player.getWaterBonusIncrease();
        this.fertilizerNeeded = 1;
        this.fertilizerBonusLimit = (super.fertilizerBonusLimit + 2) + player.getFertilizerBonusIncrease();
        this.baseSelling = super.baseSelling + 19;
        this.produceCount = 1;
        this.xpYield = 7.5f;
        this.harvestTimeInDays = 3;
        this.seedCost = (super.seedCost + 20) + player.getSeedCostReduction();;
