...
public class Mango extends Plants{
    public Mango(Farmer player){
        ...
        this.cropType = "Fruit";
        this.waterNeeded = 7;
        this.waterBonusLimit = (super.waterBonusLimit + 7) + player.getWaterBonusIncrease();
        this.fertilizerNeeded = 4;
        this.fertilizerBonusLimit = (super.fertilizerBonusLimit + 4) + player.getFertilizerBonusIncrease();
        this.baseSelling = super.baseSelling + 8;
        this.produceCount = setPlantProduce(5, 15);
        this.xpYield = 25;
        this.harvestTimeInDays = 10;
        this.seedCost = (super.seedCost + 100) + player.getSeedCostReduction();;
        this.witherStatus = false;
        this.produceLowerBound = 5 + player.getBonusPerProduce();;
