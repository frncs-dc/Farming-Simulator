...
public class Apple extends Plants{
    public Apple(Farmer player){
        ...
        this.cropType = "Fruit";
        this.waterNeeded = 7;
        this.waterBonusLimit = (super.waterBonusLimit + 7) + player.getBonusPerProduce();
        this.fertilizerNeeded = 5;
        this.fertilizerBonusLimit = (super.fertilizerBonusLimit + 5) + player.getFertilizerBonusIncrease();
        this.baseSelling = super.baseSelling + 5;
        this.produceCount = setPlantProduce(10, 15);
        this.xpYield = 25;
        this.harvestTimeInDays = 10;
        this.seedCost = (super.seedCost + 200) + player.getSeedCostReduction();;
        this.witherStatus = false;
        this.produceLowerBound = 10 + player.getBonusPerProduce();;
